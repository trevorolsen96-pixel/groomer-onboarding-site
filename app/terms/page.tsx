    ...
    <main className="site-shell">
      <section className="mx-auto w-full max-w-4xl px-6 py-14 sm:py-16">
        <div className="soft-card p-8 sm:p-10">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[var(--rose-primary)]">
            Legal
          </p>
          ...
          <div className="legal-copy mt-8 space-y-8">
            ...
            <section>
              ...
              <p>You agree not to misuse the service. This includes not:</p>
              <ul>
                <li>violating applicable laws or regulations;</li>
                <li>attempting to gain unauthorized access to the platform;</li>
                <li>interfering with the security or performance of the service;</li>
                <li>uploading malicious code or harmful content; or</li>
                <li>using the service to send unlawful or unauthorized messages.</li>
              </ul>
            </section>
            ...
            <section>
              <h2>7. Payments and Subscription Terms</h2>
              <p>

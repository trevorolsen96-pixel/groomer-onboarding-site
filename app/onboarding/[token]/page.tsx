      ...
      <div className="mx-auto max-w-4xl">
        ...
        <form onSubmit={handleSubmit} className="soft-card space-y-8 p-6">
                ...
                {agreements.map((agreement) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <label className="mt-4 flex items-start gap-3 rounded-xl border border-[var(--divider-soft)] bg-white p-4">
                        <input
                          type="checkbox"
          ...
          <section>
            ...
            <label className="mt-4 flex items-start gap-3 rounded-xl border border-[var(--divider-soft)] bg-[var(--soft-surface)] p-4">
              <input
                type="checkbox"
                className="mt-1 h-4 w-4"
